...
namespace BookStore.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            ViewData["BookId"] = new SelectList(_context.Books, "Id", "Content");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CommentString,BookId")] Comment comment)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Books, "Id", "Content", comment.BookId);
            return View(comment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CommentString,BookId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
